	  ...
	  case MODE_PAUSE:
		  ...
		  while(sysState==MODE_PAUSE)
		  {
			  ...
			  if(pauState==0)
			  {
				  ...
				  {
					  pauspeed-=(stateshift+14000-paucounter)*5;
				  ...
				  {
					  pauspeed+=(paucounter+14000-stateshift)*5;
					  stateshift=paucounter;
				  }else if(stateshift>paucounter)
				  {
					  pauspeed-=(stateshift-paucounter)*5;
					  stateshift=paucounter;//逆时针
				  }
				  ...
				  char pauspeedout[5];
				  sprintf(pauspeedout,"%d",pauspeed);
				  ...
				  }else if(danji)
				  {
					  ...
					  if(pauspeed>0)
					  {
						  __HAL_TIM_SET_COMPARE(&htim2,TIM_CHANNEL_3,(pauspeed*10/3)-1);
						  HAL_GPIO_WritePin(zheng_GPIO_Port, zheng_Pin, SET);
						  HAL_GPIO_WritePin(fu_GPIO_Port, fu_Pin, RESET);
						  pauState=1;
					  }else if(pauspeed<0)
	  ...
	  case MODE_SPIN:
		  ...
		  while(1)
		  {
			  ...
			  case 0:
				  ...
				  {
					  spispeed-=(stateshift+14000-spicounter)*5;
				  ...
				  {
					  spispeed+=(spicounter+14000-stateshift)*5;
					  stateshift=spicounter;
				  }else if(stateshift>spicounter)
				  {
					  spispeed-=(stateshift-spicounter)*5;
					  stateshift=spicounter;//逆时针
				  }
				  ...
				  sprintf(spispeedout,"%d",spispeed);
			  ...
			  case 1:
				  ...
				  if(stateshift>=0&&stateshift<=1000&&spicounter>=4000)
				  {
					  spiround-=(stateshift+14000-spicounter)*0.5;
					  stateshift=spicounter;//逆时针
				  }else if(stateshift<spicounter)
				  {
				  ...
				  {
					  spiround+=(spicounter+14000-stateshift)*0.5;
					  stateshift=spicounter;
				  }else if(stateshift>spicounter)
				  {
			  ...
			  case 2:
				  ...
				  if(spispeed>0)
				  {
					  __HAL_TIM_SET_COMPARE(&htim2,TIM_CHANNEL_3,(spispeed*10/3)-1);
					  HAL_GPIO_WritePin(zheng_GPIO_Port, zheng_Pin, SET);
					  HAL_GPIO_WritePin(fu_GPIO_Port, fu_Pin, RESET);
				  }else if(spispeed<0)
				  {
	  ...
	  case MODE_TARGET:
		  ...
		  while(1)
		  {
			  ...
			  case 0:
				  ...
				  {
					  tarspeed-=(stateshift+14000-tarcounter)*5;
				  ...
				  {
					  tarspeed+=(tarcounter+14000-stateshift)*5;
					  stateshift=tarcounter;
				  }else if(stateshift>tarcounter)
				  {
			  ...
			  case 1:
				  ...
				  if(stateshift>=0&&stateshift<=1000&&tarcounter>=4000)
				  {
					  tarround-=(stateshift+14000-tarcounter)*0.5;
					  stateshift=tarcounter;//逆时针
				  }else if(stateshift<tarcounter)
				  {
				  ...
				  {
					  tarround+=(tarcounter+14000-stateshift)*0.5;
					  stateshift=tarcounter;
				  }else if(stateshift>tarcounter)
				  {
			  ...
			  case 2:
				  ...
				  if(stateshift>=0&&stateshift<=1000&&tarcounter>=4000)
				  {
					  tarlocation-=(stateshift+14000-tarcounter)*0.5;
					  stateshift=tarcounter;//逆时针
				  }else if(stateshift<tarcounter)
				  {
				  ...
				  {
					  tarlocation+=(tarcounter+14000-stateshift)*0.5;
					  stateshift=tarcounter;
				  }else if(stateshift>tarcounter)
				  {
			  ...
			  case 4:
				  ...
				  if(tarcounter%1386-locationstate%1386<=-50||tarcounter%1386-locationstate%1386>=50)
				  {
				  ...
				  if(f==-1)
				  {
					  ...
					  {
						  tarcounter=__HAL_TIM_GET_COUNTER(&htim3);
						  if((tarcounter%1386-locationstate%1386>=-5&&tarcounter%1386-locationstate%1386<=5))
						  {
							  stops();
							  f=0;
							  HAL_Delay(200);
			  ...
			  while(1)
			  {
				  ...
				  if(jiansu==255)
				  {
					  ...
					  while(1)
					  {
						  ...
						  a=__HAL_TIM_GET_COUNTER(&htim3);
						  if(a%1386-693>-20&&a%1386-693<20)
						  {
							  break;
						  }
					  }
